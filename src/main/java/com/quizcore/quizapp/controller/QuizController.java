...
public class QuizController {
	...
	@GetMapping("/{quizId}")
	public BaseResponse<GetQuizDetailsResponse> getQuizDetails(@PathVariable("quizId") String quizId){
	...
	public BaseResponse<GetQuizQuestionsResponse> getQuizQuestions(@PathVariable("quizId") String quizId){
